...
// ketika jendela website discroll kita akan memberikan class baru,
//dengan nama nva-scrool-active,ketika jendela discroll lebih dari 0 kedalam class menuNav
window.addEventListener('scroll', () => {
    menuNav.classList.toggle('nav-scroll-active', window.scrolslY > 0);
